...
def init_db() -> None:
    ...
    try:
        ...
        CREATE INDEX IF NOT EXISTS idx_trade_journal_entries_paper_trade_id ON trade_journal_entries(paper_trade_id);
...
_ALLOWED_TABLES = frozenset({
    "signals", "paper_trades", "backtest_runs", "backtest_trades",
    "equity_curve", "alerts", "alert_config", "trade_journal_entries",
