"""
Fast profitability analysis using sample of 30-day data.
Tests key configurations on 2000 candles (~7 days).
"""
...
def load_sample_candles(n=2000):
    """Load sample of candles from cached file."""
    ...
    print(f"Loading {n} candles from cached data...")
...
def main():
    candles = load_sample_candles(n=2000)
    ...
    print("\n" + "=" * 80)
    print("  FAST PROFITABILITY ANALYSIS")
    print("=" * 80)
    ...
    configs = [
        ...
        {"reward_multiple": 2.5, "max_hold_bars": 50, "breakeven_threshold": 1.5,
         "min_confidence": 0.40, "min_confluence": 0.35, "regime_filter": False,
    ...
    # Save results
    output_path = Path(__file__).parent.parent / "fast_analysis_7d.json"
