...
import { formatPrice, type BacktestRun } from '../types/market'
...
export default function BacktestPanel() {
  ...
  const runBacktest = async () => {
    ...
    try {
      ...
      setError((e instanceof Error ? e.message : null) || 'Backtest error')
    } finally {
      setRunning(false)
    }
  }
  ...
  const parseCsvFile = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'CSV parse error')
    } finally {
      setCsvParsing(false)
    }
  }
  ...
  const runCsvBacktest = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Backtest error')
    } finally {
      setRunning(false)
    }
  }
