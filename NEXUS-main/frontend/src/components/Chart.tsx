...
export function Chart({ targetRiskReward }: { targetRiskReward: number | 'best' }) {
  ...
  useEffect(() => {
    ...
    if (seriesRef.current && typeof seriesRef.current.setMarkers === 'function') seriesRef.current.setMarkers(markers)
  }, [featuredSignals])
  ...
  useEffect(() => {
    ...
    if (seriesRef.current && typeof seriesRef.current.setMarkers === 'function') seriesRef.current.setMarkers(patternMarkers)
